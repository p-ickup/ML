...
def build_raw_features(loc_cache, flight_row, earliest_time):
    ...
    home_lat, home_lng = loc_cache.get_coordinates(school_name)
    air_lat, air_lng = loc_cache.get_coordinates(airport_name)
    ...
    min_wait       = flight_row["MinWaitTime"]
    max_wait       = flight_row["MaxWaitTime"]
    bag_no         = flight_row["BagNumber"]
    max_price      = flight_row["MaxSpendingRange"]
    dropoff_range  = flight_row["DropOffRange"]
